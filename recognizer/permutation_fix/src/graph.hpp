...
class digraph {
    private:
        ...
        unordered_map<int,int> _node_copy_counter;
    ...
    public:
        ...
        vector<int> get_innodesList_uniq(int edgeLabel, int node_name);

        void get_innodesList(int edgeLabel, int node_name, vector<int>& innodesList, vector<int>& innodes_name);
        ...
        void in_edge_group_conflict_fix(int& small_node, int& large_node, int &accum_edgegp_size, int curr_edgegp_size, int curr_edgegp);
        
        bool in_edge_group_sort(vector<int> &edgegp_nodes, vector<vector<int> > &edgegp_node_2_innodes_vec, vector<int> &index, int &accum_edgegp_size, int curr_edgegp);
